"""
Tests for plan_stack.py: an item's unlanded dependencies as the chain of branches below
it in a GitHub stack.
"""
...
def make_item(
    identifier: str, status: ItemStatus = ItemStatus.IN_PROGRESS, **fields
) -> Item:
    """
...
def test_the_chain_runs_bottom_first_and_skips_landed_layers():
    ...
    assert stack.trunk == "develop"
    assert stack.repository == REPOSITORY
...
def test_the_command_prints_the_stack_as_json(
