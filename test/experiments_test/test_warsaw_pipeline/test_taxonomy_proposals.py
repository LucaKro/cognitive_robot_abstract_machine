...
def test_a_real_run_s_proposals_are_exactly_what_is_added(vocabulary, known, taxonomy):
    """
    Exactly what the run proposed is what the classification step is shown beyond the
    ontology: a proposal that is not added is a class no body can be given.
    """
