...
with world.modify_world():
    ...
    # together with the BodySpec generated by ProduceBox.create_body_spec.
    ...
    produce_box_with_apples = ProduceBox.create_with_new_body_in_world(
        world=world,
        body_spec=ProduceBox.create_body_spec(
            PrefixedName("produce_box_with_apples"), scale=Scale(1.0, 1.0, 0.3)
        ),
...
with world.modify_world():
    empty_produce_box = ProduceBox.create_with_new_body_in_world(
        world=world,
        body_spec=ProduceBox.create_body_spec(
            PrefixedName("empty_produce_box"), scale=Scale(1.0, 1.0, 0.3)
        ),
        world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(x=0.3),
    )
