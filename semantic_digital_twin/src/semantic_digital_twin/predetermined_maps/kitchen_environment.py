    ...
    def _build_environment_walls(self, world: World):
        ...
        with world.modify_world():
            ...
            south_wall2 = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("south_wall2"), scale=Scale(x=0.05, y=0.29, z=3.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            south_wall3 = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("south_wall3"), scale=Scale(x=0.05, y=1.085, z=1.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
                    x=-0.29, y=-0.9925
                ),
            )
            ...
            south_wall4 = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("south_wall4"), scale=Scale(x=0.05, y=0.29, z=1.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            south_wall5 = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("south_wall5"), scale=Scale(0.05, 0.29, 1.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
                    x=-0.145, y=0.45, yaw=np.pi/2
                ),
            )
            ...
            south_wall6 = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("south_wall6"), scale=Scale(0.05, 2.75, 1.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
                    x=-0.29025, y=1.80
                ),
            )
            ...
            south_wall7 = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("south_wall7"), scale=Scale(0.05, 2.27, 1.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
                    x=-0.29025, y=5.16
                ),
            )
            ...
            east_wall = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("east_wall"), scale=Scale(0.05, 4.924, 3.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            middle_wall = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("middle_wall"), scale=Scale(0.05, 2.67, 1.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
                    x=2.20975, y=5.00
                ),
            )
            ...
            west_wall = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("west_wall"), scale=Scale(0.05, 4.449, 3.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            north_wall = Wall.create_with_new_body_in_world(
                world=world,
                body_spec=Wall.create_body_spec(PrefixedName("north_wall"), scale=Scale(0.05, 8.04, 3.00)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
                    x=4.949, y=1.51
                ),
            )
    ...
    def _build_environment_furniture(self, world: World):
        ...
        with world.modify_world():
            ...
            cupboard = Cupboard.create_with_new_body_in_world(
                world=world,
                body_spec=Cupboard.create_body_spec(PrefixedName("cupboard"), scale=cupboard_scale, wall_thickness=0.02),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            shelf_1 = ShelfLayer.create_with_new_body_in_world(
                world=world,
                body_spec=ShelfLayer.create_body_spec(PrefixedName("shelf_1"), scale=Scale(0.40, 0.76, 0.02)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            shelf_2 = ShelfLayer.create_with_new_body_in_world(
                world=world,
                body_spec=ShelfLayer.create_body_spec(PrefixedName("shelf_2"), scale=Scale(0.40, 0.76, 0.02)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            left_door = Door.create_with_new_body_in_world(
                world=world,
                body_spec=Door.create_body_spec(PrefixedName("cupboard_left_door"), scale=door_scale),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            left_door_handle = Handle.create_with_new_body_in_world(
                world=world,
                body_spec=Handle.create_body_spec(PrefixedName("left_door_handle"), scale=Scale(0.04, 0.02, 0.02)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            cupboard_left_door_hinge = Hinge.create_with_new_body_in_world(
                world=world,
                body_spec=Hinge.create_body_spec(PrefixedName("cupboard_left_door_hinge")),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            right_door = Door.create_with_new_body_in_world(
                world=world,
                body_spec=Door.create_body_spec(PrefixedName("cupboard_right_door"), scale=door_scale),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            right_door_handle = Handle.create_with_new_body_in_world(
                world=world,
                body_spec=Handle.create_body_spec(PrefixedName("right_door_handle"), scale=Scale(0.04, 0.02, 0.02)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            cupboard_right_door_hinge = Hinge.create_with_new_body_in_world(
                world=world,
                body_spec=Hinge.create_body_spec(PrefixedName("cupboard_right_door_hinge")),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            oven = Oven.create_with_new_body_in_world(
                world=world,
                body_spec=Oven.create_body_spec(PrefixedName("oven"), scale=Scale(1.20, 0.658, 1.49)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            trash_can = TrashCan.create_with_new_body_in_world(
                world=world,
                body_spec=TrashCan.create_body_spec(PrefixedName("trash_can"), scale=Scale(x=0.30, y=0.30, z=0.40)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            refrigerator = Fridge.create_with_new_body_in_world(
                world=world,
                body_spec=Fridge.create_body_spec(PrefixedName("refrigerator"), scale=Scale(x=0.60, y=0.658, z=1.49)),
                world_root_T_self=HomogeneousTransformationMatrix.from_xyz_rpy(
            ...
            counterTop = CounterTop.create_with_new_body_in_world(
                world=world,
                body_spec=CounterTop.create_body_spec(PrefixedName("counterTop"), scale=Scale(x=2.044, y=0.658, z=0.545)),
            ...
            table = Table.create_with_new_body_in_world(
                world=world,
                body_spec=Table.create_body_spec(PrefixedName("table"), scale=Scale(x=2.45, y=0.796, z=0.845)),
            ...
            sofa = Sofa.create_with_new_body_in_world(
                world=world,
                body_spec=Sofa.create_body_spec(PrefixedName("sofa"), scale=Scale(x=1.68, y=0.94, z=0.68)),
            ...
            lowerTable = Table.create_with_new_body_in_world(
                world=world,
                body_spec=Table.create_body_spec(PrefixedName("lowerTable"), scale=Scale(x=0.37, y=0.91, z=0.44)),
            ...
            desk = Table.create_with_new_body_in_world(
                world=world,
                body_spec=Table.create_body_spec(PrefixedName("desk"), scale=Scale(x=0.60, y=1.20, z=0.75)),
            ...
            cooking_table = Table.create_with_new_body_in_world(
                world=world,
                body_spec=Table.create_body_spec(PrefixedName("cooking_table"), scale=Scale(1.75, 0.64, 0.71)),
            ...
            dinning_table = Table.create_with_new_body_in_world(
                world=world,
                body_spec=Table.create_body_spec(PrefixedName("dining_table"), scale=Scale(0.73, 1.18, 0.73)),
