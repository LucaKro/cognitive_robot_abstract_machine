...
class SpatialVariables(Enum):
    ...
    @classproperty
    def pose(cls) -> Quantities:
        """
        :return: The six degrees of freedom of a pose, and the layout of every array
            over them.

        ..note:: A layout rather than a :class:`SortedSet`, because the position of a
            variable here is the row and column it occupies in a matrix over them.
        """
        return Quantities.of(*cls.position, *cls.rotation)
