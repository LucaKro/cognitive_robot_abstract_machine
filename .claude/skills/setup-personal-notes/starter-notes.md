...
- Push only to your own fork's remote. Never push to the upstream repository
  your fork was made from, whatever the reason; work reaches it through pull
  requests the user opens.
